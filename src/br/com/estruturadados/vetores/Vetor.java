...
public class Vetor<T> {
	...
	private Object[] elementos; // troca pessoas por elementos
	private int posicao;
	
	public Vetor(int capacidade) {
		//this.pressoas = new Pessoa[capacidade];
	...
	*/
	...
	@SuppressWarnings("unchecked") // suprimir (ignorar) avisos do compilador sobre operações não verificadas envolvendo tipos genérico
	public T recuperar(int posicao) { // troca Pessoa por T
		if (posicao >= tamanho()) {
	...
	public void remover(T elemento) {
		...
		if (posicao >= tamanho() || posicao == -1) {
			throw new IllegalArgumentException(String.format("Elemento inválido", elementos.toString()));
		}
	}
